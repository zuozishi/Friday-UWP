...
namespace Friday.Views.UserPages
{
    ...
    /// </summary>
    public sealed partial class MyObsPage : Page
    {
        ...
        private async void LoadObsData()
        {
            if (HttpPostUntil.isInternetAvailable)
            {
                ...
                var json =await HttpPostUntil.HttpPost(Data.Urls.user.myobs, new Windows.Web.Http.HttpFormUrlEncodedContent(postdata));
                try
                {
